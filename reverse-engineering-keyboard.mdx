...
<h1>
  ...
  <span className="text-primary-dark">/</span>Reverse Engineering a Keyboard for
  OpenRGB<span className="text-primary-dark">/</span>
</h1>
...
![Detection](https://github.com/Voltonik/blog/blob/main/images/client-side-prediction-1.png?raw=true)
...
![Wireshark](https://github.com/Voltonik/blog/blob/main/images/client-side-prediction-2.png?raw=true)
...
![thing](https://github.com/Voltonik/blog/blob/main/images/client-side-prediction-3.png?raw=true)
...
![RGBbuffer](https://github.com/Voltonik/blog/blob/main/images/client-side-prediction-4.png?raw=true)
